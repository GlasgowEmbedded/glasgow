...
__all__ = ["devices", "devices_tree"]



class MSP430Device(namedtuple("MSP430Device", (
    "device", "jtag_id", "device_id", "ext_id",
    ...
    def __repr__(self):
        return "MSP430Device({device!r}, 0x{jtag_id:02x}, 0x{device_id:04x}, {ext_id}, core={core!r}, type={type!r}, features={features!r}, pkg_variants={pkg_variants!r})".format(
            device = self.device,
            jtag_id = self.jtag_id,
            device_id = self.device_id,
            ext_id = ('0x%02x' % (self.ext_id,)) if (self.ext_id is not None) else 'None',
            core = self.core,
            type = self.type,
            features = self.features,
            pkg_variants = self.pkg_variants,
        )
...
# Build device tree of jtag_id, device_id, ext_id
devices_tree = {}

...
class _GlasgowRevDPlatform(GlasgowECP5Platform):
    ...
    resources   = [
        ...
        Resource("fx2", 0,
            Subsignal("sloe",    Pins("B5", dir="o"), Attrs(PULLMODE="UP")),
            Subsignal("slrd",    Pins("E9", dir="o"), Attrs(PULLMODE="UP")),
            Subsignal("slwr",    Pins("D10", dir="o"), Attrs(PULLMODE="UP")),
        ...
        Resource("octoram", 1,
            ...
            Subsignal("dq",  Pins( "R14 P14 T15 R15 T14 R13 P13 N13", dir="io")),
            Attrs(IO_TYPE="LVCMOS18", SLEWRATE="FAST")
        ),
        ...
        Resource("afe_adc", 0,
            Subsignal("reset", PinsN("A15", dir="o"), Attrs(PULLMODE="UP")),
            Subsignal("cs",    PinsN("C9",  dir="o"), Attrs(PULLMODE="UP")),
        ...
        Resource("port_a", 0,
                 Subsignal("io", Pins("B2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("B1", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 1,
                 Subsignal("io", Pins("D3"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("C3", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 2,
                 Subsignal("io", Pins("C2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("C1", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 3,
                 Subsignal("io", Pins("F3"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("E3", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 4,
                 Subsignal("io", Pins("E2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("D1", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 5,
                 Subsignal("io", Pins("F5"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("F4", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 6,
                 Subsignal("io", Pins("G5"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("G4", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_a", 7,
                 Subsignal("io", Pins("E1"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("F2", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),

        Resource("port_b", 0,
                 Subsignal("io", Pins("G2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("F1",  dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 1,
                 Subsignal("io", Pins("H3"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("G3", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 2,
                 Subsignal("io", Pins("H4"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("H5", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 3,
                 Subsignal("io", Pins("J5"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("J4", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 4,
                 Subsignal("io", Pins("H2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("G1", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 5,
                 Subsignal("io", Pins("K3"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("J3", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 6,
                 Subsignal("io", Pins("J2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("J1", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_b", 7,
                 Subsignal("io", Pins("K2"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("K1", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),

        Resource("port_c", 0,
                 Subsignal("io", Pins("B16"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("B15",  dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 1,
                 Subsignal("io", Pins("C14"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("D14", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 2,
                 Subsignal("io", Pins("C16"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("C15", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 3,
                 Subsignal("io", Pins("E14"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("F14", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 4,
                 Subsignal("io", Pins("D16"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("E15", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 5,
                 Subsignal("io", Pins("F13"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("F12", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 6,
                 Subsignal("io", Pins("G12"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("G13", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_c", 7,
                 Subsignal("io", Pins("F15"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("E16", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),

        Resource("port_d", 0,
                 Subsignal("io", Pins("F16"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("G15",  dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 1,
                 Subsignal("io", Pins("G14"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("H14", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 2,
                 Subsignal("io", Pins("H12"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("H13", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 3,
                 Subsignal("io", Pins("J13"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("J12", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 4,
                 Subsignal("io", Pins("G16"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("H15", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 5,
                 Subsignal("io", Pins("J14"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("K14", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 6,
                 Subsignal("io", Pins("J16"), Attrs(PULLMODE="UP")),
                 Subsignal("oe", Pins("J15", dir="o")),
                 Attrs(IO_TYPE="LVCMOS33")),
        Resource("port_d", 7,
                 Subsignal("io", Pins("K16"), Attrs(PULLMODE="UP")),

    ...
    async def run(self, args):
        ...
        if args.operation == "read-flash":
            ...
            if args.burst:
                ...
                words = await self.mec_iface.read_flash_burst(starting_address, (real_size_bytes + 3) // 4)
            else:
                ...
                words = await self.mec_iface.read_flash(starting_address, (real_size_bytes + 3) // 4)
        ...
        if args.operation == "erase-flash":
            ...
            if starting_address or final_bytes_to_skip:
                await self.mec_iface.erase_flash_range(starting_address, args.size_bytes - starting_address - final_bytes_to_skip)
            else:

...
class SpyBiWireProbeComponent(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.controller = controller = SpyBiWireProbeController(self._ports, width=8, period_cyc=self._period_cyc)
        ...
        m.d.comb += [
            ...
            Cat(controller.tclk_level, controller.tclk_latch, controller.tclk_toggle).eq(driver.aux_o)
        ]

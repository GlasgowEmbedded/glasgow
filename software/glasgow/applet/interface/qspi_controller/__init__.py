...
class QSPIControllerInterface:
    ...
    async def exchange(self, octets):
        self._log("swap-o=<%s>", dump_hex(octets))
    ...
    async def read(self, count, *, x=1):
        ...
        self._log("get=<%s>", dump_hex(octets))
        return octets

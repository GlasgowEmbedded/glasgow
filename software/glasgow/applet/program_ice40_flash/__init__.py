...
class ProgramICE40FlashApplet(SPIFlash25CApplet, name='program-ice40-flash'):
    ...
    help = "read and write 25C-compatible Flash memories used with iCE40 FPGAs"
    description = """
    Program the 25C-compatible Flash memories found on many boards with iCE40 series FPGAs.
    This applet is based on the spi-flash-25c applet; in addition, it asserts the FPGA reset
    while programming the memory, and checks the CDONE pin to determine whether the FPGA has
    successfully read the configuration after the applet finishes.

    See the description of the spi-flash-25c applet for details.
    """

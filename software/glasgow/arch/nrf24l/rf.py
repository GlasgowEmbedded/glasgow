...
__all__ = [
    # Command opcodes
    "OP_R_REGISTER", "OP_W_REGISTER", "OP_R_RX_PAYLOAD", "OP_W_TX_PAYLOAD",
    "OP_FLUSH_TX", "OP_FLUSH_RX", "OP_REUSE_TX_PL", "OP_NOP",
    # Register addresses
    ...
    "ADDR_RX_ADDR_Pn", "ADDR_TX_ADDR", "ADDR_RX_PW_Pn", "ADDR_TX_STATUS",
    # Registers

...
+========+=======+=============+======================================================================================================================================================+
| 1      | SENSE | Blue        | Voltage sense, connected to VBUS pin of INA233. Tie to pin 2 to enable VIO power measurement feature, or use as an arbitrary 0-36V 16-bit ADC input. |
+--------+-------+-------------+------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2      | VIO   | Red         | Logic level voltage output. Generated by TPS73101DBV linear regulator, voltage level configured at runtime by DAC081C081CIMK DAC.                    |
+--------+-------+-------------+------------------------------------------------------------------------------------------------------------------------------------------------------+
